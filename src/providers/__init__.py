...
from src.providers.scenario_input import ScenarioReportInput, VectorReference, build_scenario_report_input
...
__all__ = [
    ...
    "VectorReference", "ScenarioReportInput", "build_scenario_report_input",
]
